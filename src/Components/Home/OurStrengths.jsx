...
export default function OurStrengths() {
  return (
    <div className="md:px-6 xl:px-10 3xl:px-16 px-3">
      ...
      <ul className="sm:flex grid grid-cols-3 justify-between md:gap-10 gap-5 md:py-6 py-3  ">
        {data.list.map((d, i) => (
          <li
          ...
          >
            <img
              src={d.img}
              alt=""
              className="sm:w-12 sm:h-12 w-8 h-8 group-hover:-translate-y-2 duration-300 "
            />
