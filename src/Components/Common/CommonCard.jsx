...
function CommonCard(props) {
  ...
  return (
    <li className="w-full grid place-items-center justify-center lg:p-5 sm:p-3 p-2 bg-light rounded-lg space-y-4 font-Nunito my-2 hover:shadow-md duration-300   h-full">
