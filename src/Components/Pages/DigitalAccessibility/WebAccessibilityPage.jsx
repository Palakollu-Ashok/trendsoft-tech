...
import data from "../../../Content/OurSolutions/DigitalAccessibility/WebAccessibility/Card.json";
...
export default function WebAccessibilityPage() {
  ...
  return (
    <>
      ...
      />
      <div className=" bg-gray-100 sm:py-4 py- md:px-6 xl:px-10 3xl:px-16  px-3 h-full">
        <div className="">
