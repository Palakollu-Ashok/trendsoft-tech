...
import PerformanceTestingServices from "../../OurSolutions/Testing/PerformanceTestingServices";
...
export default function PerformanceTestingPage() {
  ...
  return (
    <>
      <MetaTags>
        <title>Trendsoft | Performance Testing Page</title>
      ...
      <Banner
        BgImg={BgImg}
        desc=" Performance Testing Auditing Solutions"
