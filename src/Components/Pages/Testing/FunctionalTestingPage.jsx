...
import Img from "../../../assets/Home/FunctionalTesting.jpg";
import Banner from "../../Common/Banner";
import Empower from "../../Common/Empower";
import BredCrumb from "../../Common/BredCrumb";
import FunctionalTsestingServices from "../../OurSolutions/Testing/FunctionalTsestingServices";
...
export default function FunctionalTestingPage() {
  ...
  return (
    <>
      <MetaTags>
        <title>Trendsoft | Functional Testing Page</title>
      ...
      <Banner
        BgImg={BgImg}
        desc=" Functional Testing Auditing Solutions"
